...
let config = {
    ...
    token:'0063b993d95e10c445da7d06329e66e3392IAA5sXUtq0W7nDvTInCIGZOW1YlFVBeR20sYrBh/3pyXhlY6vQoAAAAAEACQKMvtEUnVYgEAAQARSdVi',
    uid:null,
    channel:'chn3',
}
...
let remoteTracks = {}
    ...
    document.getElementById('refugees').addEventListener('click', async () => {
        config.uid = "Enrique";
        await joinStreams();
